...
compartment("mqtt_demo")
  ...
  add_deps("freestanding", "TCPIP", "NetAPI", "TLS", "Firewall", "SNTP", "MQTT", "time_helpers", "debug", "javascript")
  add_files("demo.cc")
...
compartment("javascript")
  add_deps("freestanding", "microvium", "debug")
  add_files("javascript.cc")
