...
set_project("CHERIoT wolfSSL MQTT Example")
...
compartment("mqtt_wolfssl_example")
  add_includedirs("../../include")
  add_deps("freestanding", "DNS", "TCPIP", "NetAPI", "WolfSSLTLS", "WolfSSLMQTT",
           "Firewall", "SNTP", "time_helpers", "debug")
  add_deps("stdio")
  add_files("mqtt_wolfssl.cc")
  add_rules("cheriot.network-stack.ipv6")

firmware("08.mqtt_wolfssl_example")
  set_policy("build.warning", true)
  add_deps("mqtt_wolfssl_example")
