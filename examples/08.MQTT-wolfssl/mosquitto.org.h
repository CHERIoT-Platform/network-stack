// Trust anchor for test.mosquitto.org:8883 (TLS-encrypted MQTT broker, valid 2020-2030).
//
// To regen:
//   1. Download the CA certificate:
//        curl https://test.mosquitto.org/ssl/mosquitto.org.crt -o mosquitto.org.crt
//   2. Convert PEM -> DER:
//        openssl x509 -in mosquitto.org.crt -outform DER -out mosquitto.org.der
//   3. Convert to a C byte array:
//        xxd -i comodo_aaa.der \
//          | sed -e '1s/.*/static const unsigned char MOSQUITTO_ORG_CA_DER[] = {/' \
//                -e '/^unsigned int/d'
//
static const unsigned char MOSQUITTO_ORG_CA_DER[] = {
